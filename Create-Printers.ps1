...
#
# Updated by Greg Morford
# - Added argument for passing CSV file path
# - Adjusted several printer attributes to match our environment
###########################################################################"
...
$printers = Import-Csv $args[0]

foreach ($printer in $printers) {
CreatePrinterPort $printer.Printserver $printer.Portname $printer.Portname
